                    ...
                    <div class="card-body">
                        <form id="submitForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('bobot_kriteria') is-invalid @enderror" id="bobot_kriteria" name="bobot_kriteria" value="{{ $kriteria->bobot_kriteria }}" />
    ...
    <script>
        $(document).ready(function() {
            $('#submitForm').on('submit', function(event) {
                ...
                $.ajax({
                    url: "{{ route('kriteria.update', $kriteria->id) }}",
                    method: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
