            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Tambah Pangkat</h5>
                    </div>
                    <div class="card-body">
                        <form id="submitForm">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('pangkat') is-invalid @enderror" id="pangkat" name="pangkat" value="{{ old('pangkat') }}" placeholder="Masukkan Pangkat" />
