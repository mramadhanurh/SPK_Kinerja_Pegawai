...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="py-3 mb-4" style="text-align: right;"><span class="text-muted fw-light">Home /</span> Data Bobot</h5>

        <div class="row">
            <div class="card">
                <h5 class="card-header">Data Bobot</h5>
                <div class="table-responsive text-nowrap">
                    <a href="{{ route('bobot.create') }}" class="btn btn-success float-end">
                        Tambah Bobot
                    </a>
                    <br><br><br>
                    <table id="basic-datatables" class="table table-striped table-hover">
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($bobots as $item)
                            <tr id="index_{{ $item->id }}">
                                <td class="text-center">{{ $loop->iteration }}</td>
                                <td>{{ $item->nama_bobot }}</td>
                                <td class="text-center">{{ $item->nilai }}</td>
                                <td class="text-center">
                                    <a href="{{ route('bobot.edit', $item->id) }}" type="button" class="btn btn-warning btn-sm btn-flat" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="EDIT">
