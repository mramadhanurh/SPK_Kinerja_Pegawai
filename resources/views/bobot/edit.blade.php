                    ...
                    <div class="card-body">
                        <form id="submitForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_bobot') is-invalid @enderror" id="nama_bobot" name="nama_bobot" value="{{ $bobot->nama_bobot }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nilai') is-invalid @enderror" id="nilai" name="nilai" value="{{ $bobot->nilai }}" />
    ...
    <script>
        $(document).ready(function() {
            $('#submitForm').on('submit', function(event) {
                ...
                $.ajax({
                    url: "{{ route('bobot.update', $bobot->id) }}",
                    method: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
