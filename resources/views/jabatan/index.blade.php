...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="py-3 mb-4" style="text-align: right;"><span class="text-muted fw-light">Home /</span> Data Jabatan</h5>

        <div class="row">
            <div class="card">
                <h5 class="card-header">Data Jabatan</h5>
                <div class="table-responsive text-nowrap">
                    <a href="{{ route('jabatan.create') }}" class="btn btn-success float-end">
                        Tambah Jabatan
                    </a>
                    <br><br><br>
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <tr id="index_{{ $item->id }}">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('jabatan.edit', $item->id) }}" type="button" class="btn btn-warning btn-sm btn-flat" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="EDIT">
